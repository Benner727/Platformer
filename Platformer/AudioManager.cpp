...
void AudioManager::Volume(int volume)
{
	...
	Mix_VolumeMusic(MIX_MAX_VOLUME / 3.0f * (float)(mVolume / 100.0f)); //Music Volume
	Mix_Volume(1, MIX_MAX_VOLUME / 10.0f * (float)(mVolume / 100.0f)); //Player shooting
	Mix_Volume(2, MIX_MAX_VOLUME / 4.0f * (float)(mVolume / 100.0f)); //Boss attacks
	Mix_Volume(3, MIX_MAX_VOLUME / 5.0f * (float)(mVolume / 100.0f)); //Boss steps
	Mix_Volume(4, MIX_MAX_VOLUME / 5.0f * (float)(mVolume / 100.0f)); //Splash
	Mix_Volume(5, MIX_MAX_VOLUME / 5.0f * (float)(mVolume / 100.0f)); //Reload
}
